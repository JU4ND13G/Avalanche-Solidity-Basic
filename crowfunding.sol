...
contract crowdFunding {
    ...
    // funcion permite enviar los fondos
    ...
    function refund() public {
        require(block.timestamp < deadline && reaisedAmount < targetAmount, "no se cumplio el objetivo");
    ...
    function createRequest(string memory _description, address payable _recipient, uint _value) public onlyManager{
        Request storage newRequest = request[numRequets];
        numRequets ++;
    ...
    function makePayament(uint _requestNum) public onlyManager{
        ...
        Request storage thisRequest = request[_requestNum];
